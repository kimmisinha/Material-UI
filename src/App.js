...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Button variant="contained" color="warning" endIcon={<AcUnitIcon />}>
        Delete
      </Button>
      <h1>Icon Button</h1>
 ...
 <h1>Grid</h1>
  ...
  <Grid item lg={3}  md={4} sm={6} xs={12}>
    <Box bgcolor="blue" p={5}  textAlign="center">2</Box>
  </Grid>
  <Grid item lg={3}  md={4} sm={6} xs={12}>
...
<Grid container spacing={2} direction="row" justifyContent= "center">
  <Grid item lg={3}  md={4} sm={6} xs={12}>
    ...
    <Box bgcolor="yellow" p={5}  textAlign="center">
      {/* nested grid */}
      <Grid container spacing={20} direction="row" justifyContent= "center" margin="10">
        <Grid item  lg={1}  md={4} sm={6} xs={12}>
        <Box bgcolor="pink" p={5}  textAlign="center"> 1-1   </Box>
        </Grid >
        <Grid item  lg={1}  md={4} sm={6} xs={12}>
        ...
        <Grid item  lg={1}  md={4} sm={6} xs={12}>
        <Box bgcolor="pink" p={5}  textAlign="center"> 1-4 </Box>
        </Grid> 
      </Grid>
    </Box>
    </Box>
